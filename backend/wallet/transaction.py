...
class Transaction:
    ...
    def create_output(self, sender_wallet, recipient, amount):
        '''
        Stucture the output data for the transaction.
        '''
    ...
    def create_input(self, sender_wallet, output):
        '''
        Stuture the input data for the transaction.
    ...
    def to_json(self):
        '''
        Serialize the transaction. Transact the instance into serialized version.
        '''
        return self.__dict__

    @staticmethod
    def from_json(transation_json):
        '''
        Deserialize a transaction's json representation back into a Transaction instance
        '''
        return Transaction(**transation_json)
        # **: unpacking operator
