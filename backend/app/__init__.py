...
# asterisk is a symbol used to represent that it can match any number of falling generic characters in a string.
# r: regular express string
...
def route_blockchain_range():
    '''the URL polity is : http://localhost:5000/blockchain/range?start=2&end=5'''
...
def route_wallet_transact():
    ...
    return jsonify(transaction.to_json()) # json can only transact the basic data types
